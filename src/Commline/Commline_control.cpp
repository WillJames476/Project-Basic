...
void Commline_control::add_to_list(const std::initializer_list<std::string>& fields)
{
...
void Commline_control::remove_from_list(const std::initializer_list<std::string>& fields)
{
    auto strings_ptr{std::data(fields)};
