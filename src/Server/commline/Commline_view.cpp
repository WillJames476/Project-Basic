...
std::string
turn_bool_to_string(const bool to_convert)
{
...
std::string
Commline_view::send_formatted(const std::string& account) const
{
  std::ostringstream to_return_string{};
...
std::ostringstream
Commline_view::send_as_stream () const
{
...
void
Commline_view::read_from_stream(std::istream& to_read) const
{
