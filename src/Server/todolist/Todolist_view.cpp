...
std::string
Todolist_view::send_formatted(const std::string& account_name) const
{
...
std::ostringstream
Todolist_view::send_as_stream() const
{
...
void
Todolist_view::read_from_stream(std::istream& to_read) const
{
