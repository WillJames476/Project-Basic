...
bool Todolist_control::add_to_list(const std::initializer_list<std::string>& fields) const
{
...
bool Todolist_control::add_to_list_task(const std::initializer_list<std::string>& fields) const
{
  auto extracted_strings_ptr{std::data(fields)};
...
bool Todolist_control::remove_from_list(const std::initializer_list<std::string>& fields) const
{
  auto extracted_strings_ptr{std::data(fields)};
...
bool Todolist_control::remove_from_list_task(const std::initializer_list<std::string>& fields) const
{
  auto extracted_strings_ptr{std::data(fields)};
