...
bool Account_control::add_to_list(const std::initializer_list<std::string>& fields) const
{
  if(fields.size() == 2)
    {
...
bool Account_control::remove_from_list(const std::initializer_list<std::string>& fields) const
{
  if(fields.size() == 2)
    {
