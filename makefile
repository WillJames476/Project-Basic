...
com_lines = src/Account_Communicator/Main.cpp src/Account_Communicator/Communication_line.cpp
com_lines1 = src/Account_Communicator/Communication_line_menu.cpp
